...
<div class="page-wrapper">
    <main class="bailarin-main" style="max-width:500px;margin:0 auto;padding:20px 16px;padding-top:16px;">
        ...
        <div class="glass-card profile-card" style="text-align:center;padding:32px 24px;margin-bottom:20px;">
            ...
            <span class="badge badge-bailarin">BailarÃ­n</span>
        ...
        <div class="glass-card" style="padding:24px;">
            <h3 style="margin-bottom:16px;"><i class="fas fa-lock"></i> Cambiar ContraseÃ±a</h3>
            <form id="changePasswordForm">
                <div class="form-group">
                    <label for="currentPassword">ContraseÃ±a Actual</label>
                    <input type="password" id="currentPassword" class="form-input" placeholder="â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢" required>
                </div>
                <div class="form-group">
                    <label for="newPassword">Nueva ContraseÃ±a</label>
                    <input type="password" id="newPassword" class="form-input" placeholder="MÃ­nimo 6 caracteres" required minlength="6">
                </div>
                <div class="form-group">
                    <label for="confirmPassword">Confirmar Nueva ContraseÃ±a</label>
                    <input type="password" id="confirmPassword" class="form-input" placeholder="Repite la contraseÃ±a" required minlength="6">
                </div>
                <button type="submit" class="btn btn-primary btn-block" id="changePwdBtn">Actualizar ContraseÃ±a</button>
            </form>
        </div>

        <!-- Cerrar SesiÃ³n -->
        <div style="text-align:center;margin-top:24px;">
            <button class="btn btn-danger" onclick="logout()" style="width:100%;"><i class="fas fa-sign-out-alt"></i> Cerrar SesiÃ³n</button>
        </div>
    </main>
</div>
...
<script>
console.log('[PERFIL] PÃ¡gina cargada');
...
document.getElementById('changePasswordForm').addEventListener('submit', async (e) => {
    ...
    if (newPassword !== confirmPassword) {
        showToast('Las contraseÃ±as nuevas no coinciden', 'warning');
        return;
    }
