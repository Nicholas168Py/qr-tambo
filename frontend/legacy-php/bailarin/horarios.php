    ...
    <main class="bailarin-main" style="max-width:500px;margin:0 auto;padding:20px 16px;padding-top:16px;">
        ...
        <div class="glass-card" style="padding:12px;margin-bottom:20px;">
            <div class="day-slider" id="daySlider">
                ...
                <button class="day-slider-btn" data-day="3" onclick="switchDay(this, 2)">MiÃ©</button>
                ...
                <button class="day-slider-btn" data-day="6" onclick="switchDay(this, 5)">SÃ¡b</button>
            </div>
        </div>
...
<script>
console.log('[HORARIOS] PÃ¡gina cargada');
