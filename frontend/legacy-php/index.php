    ...
    <main class="login-main">
        <div class="login-card" id="loginCard">
            ...
            <div class="brand">
                ...
                <p class="brand-tagline">Sistema de Asistencia Â· Clases de Baile</p>
            </div>
            ...
            <form id="loginForm" autocomplete="on">
                <div class="input-group">
                    ...
                    <div class="input-control">
                        ...
                        <input type="text" id="cedula" name="cedula" class="form-input" placeholder="Ingresa tu cÃ©dula" required autofocus autocomplete="username">
                ...
                <div class="input-group">
                    ...
                    <div class="input-control">
                        ...
                        <input type="password" id="password" name="password" class="form-input" placeholder="Ingresa tu contraseÃ±a" required autocomplete="current-password">
                        <button type="button" class="input-toggle" id="passwordToggle" aria-label="Mostrar contraseÃ±a"><i class="fas fa-eye"></i></button>
                        <span class="input-focus"></span>
                    </div>
                </div>
                ...
                <button type="submit" class="login-btn" id="loginBtn">
                    ...
                    <span class="btn-label"><i class="fas fa-arrow-right-to-bracket" aria-hidden="true"></i> Iniciar SesiÃ³n</span>
                </button>
            </form>
