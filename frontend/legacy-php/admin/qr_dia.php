...
<div class="admin-layout">
    ...
    <main class="main-content">
        <div class="main-header">
            <h1><i class="fas fa-qrcode"></i> QR del DÃ­a</h1>
            <p id="dayStatus">Genera cÃ³digos QR para las clases de hoy</p>
        </div>
        ...
        <div class="qr-section" id="qrDisplay">
            <div style="text-align:center;padding:60px 20px;">
                ...
                <p style="color:var(--text-secondary);margin-top:16px;">Cargando clases del dÃ­a...</p>
            </div>
        </div>
    </main>
</div>
...
<script>
console.log('[QR_ADMIN] PÃ¡gina QR del dÃ­a cargada');
    ...
    if (success && dayClasses.length > 0) {
        ...
        document.getElementById('qrDisplay').innerHTML = `
            <div class="qr-empty" style="padding:60px 20px;">
                ...
                <h2 style="margin-bottom:12px;">No hay clases para este dÃ­a</h2>
...
initDayPills();
console.log('[QR_ADMIN] Cargando dÃ­a actual...');
